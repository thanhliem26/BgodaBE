...
{
    public class RolePermissionRepository : VigoGeneric<RolePermission>, IRolePermissionRepository
    {
        public RolePermissionRepository(VigoDatabaseContext context) : base(context)
        {
        }
    }
}
